...
const vm  = window['vm'] =  new Vue({
    ...
    methods: {
        ...
        getNumbers: function (){
            ...
            //计算当前浏览器宽高
            n.boxWidth = 800//document.body.scrollWidth
            n.boxHeight = 600//document.body.scrollHeight
        ...
        bindMouseWheel: function () {
            ...
            $box[0].addEventListener('mousewheel', function (e) {
                ...
                //纵轴每一次滚动一个单元格高度
                deltay = deltay > 0 ? n.tdHeight : -n.tdHeight

                var idx = 0
                if (deltay > 0){
                    deltay = n.tdHeight
                    idx = n.startRenderIdx - 1
                ...
                n.startRenderIdx = me.getStartIndex(idx)
                
                //根据startRenderIdx计算表格容器位置和滚动条位置
                var top = -n.startRenderIdx * n.tdHeight
        ...
        editInputBlur: function (){console.log(1)
            let n = this.numbers
