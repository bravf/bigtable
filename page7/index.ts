...
const vm  = window['vm'] =  new Vue({
    ...
    data: {
        ...
        numbers: {
            ...
            tableTop: 0,                       //表格滚动总top
            tableTop2: 0,                      //表格一个滑动区间内记录值(tableTop%tdHeight)
    ...
    methods: {
        ...
        getStartIndex: function (idx){
            ...
            idx = Math.max(0, idx)
            idx = Math.min(idx, n.dataCount - n.renderNum + 1)

            return idx
        },
        getRenderIdxByTableTop: function (){
            let n = this.numbers
            
            //求renderIdx
            let x = Math.floor(-n.tableTop/n.tdHeight)
            n.startRenderIdx = this.getStartIndex(x)

            //求tableTop2
            n.tableTop2 = n.tableTop % n.tdHeight
        },
        bindMouseWheel: function () {
            ...
            $box[0].addEventListener('mousewheel', function (e) {
                ...
                //求renderIdx 和 tableTop2
                me.getRenderIdxByTableTop()
